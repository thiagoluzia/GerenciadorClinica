...
namespace GC.Application.Services.External.GoogleCalendar
{
    public class GoogleCalendarService : IGoogleCalendarService
    {
        ...
        {
            return await _service.AtualizarEventoAgendaGoogle(idEvento, new GoogleAgenda
            {
        ...
        public async Task<Event> CriarAgendaGoogle(GoogleAgendaInputModel request, string agendaId)
        {
            return await _service.CriarAgendaGoogle(new GoogleAgenda
            {
                Descricao = request.Descricao,
                Email = request.Email,
                Fim = request.Fim,

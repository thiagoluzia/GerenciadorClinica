...
using GC.Application.CQRS.Commands.Servicos.DeletarServico;
using GC.Application.CQRS.Queries.Servicos.BuscarServico;
using GC.Application.CQRS.Queries.Servicos.BuscarServicos;
using MediatR;
